...
function TestimonialsSection() {
  const testimonials = [
    {
      name: "Olivia Walker",
      image: "https://placekitten.com/80/80", // Placeholder for user image
    ...
    {
      name: "Ashley Taylor",
      image: "https://placekitten.com/90/90", // Placeholder for user image
      text: "Really good. Luvvoice is by far the most valuable business resource we have ever purchased. I love this TTS tool.",
    },
    {
      name: "Emma Rodriguez",
      image: "https://placekitten.com/100/100", // Placeholder for user image
